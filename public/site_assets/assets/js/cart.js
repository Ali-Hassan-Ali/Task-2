        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.product.qty == 1) {
			            	...
			            	<div class="shopping-cart-img">
			            		<a href="shop-product-right.html">
			            			<div class="" style="position:relative;">
                                         <img src="${data.product_model.product.image_path_back}" alt="Product" style="background-color: ${data.product_model.default_color}"">
                                         <img class="bg-logo center-image" src="${data.product_model.logo_path}" style="width:70px;">
                                    </div>
			            		</a>
                            </div>
                            <div class="shopping-cart-title">
                                <h4><a href="">Daisy Casual Bag</a></h4>
                                <h4><span class="product-qty-${data.product.id}"> 1 × </span>${data.product.price}  ${currency}</h4>
                            </div>
                	...
                	$('.product-qty-'+id).html(data.product.qty + ' ' + 'X');
