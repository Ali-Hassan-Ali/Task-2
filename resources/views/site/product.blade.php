                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Store : <a href="{{ route('store',$product->id) }}">{{ $product->store->name }}</a></span>
                                            </div>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <div class="button button-add-to-cart add-cart"
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="shop-product-right.html" tabindex="0">{{ $product->product->name }}</a></h2>
{{--                                                     <div class="rating-result" title="90%">
                                                        <span></span>
                                                    </div> --}}
                                                    <div class="product-price">
                                                        <span>{{ app()->getLocale() == 'ar' ? 'ج م' : 'LE'}} {{ number_format($product->price,2) }}</span>
                                                        <span class="old-price">{{ app()->getLocale() == 'ar' ? 'ج م' : 'LE'}} {{ number_format($product->price,2) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
