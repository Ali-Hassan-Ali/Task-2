            ...
            <div class="row">
                <div class="col-xl col-lg flex-grow-0" style="flex-basis:230px">
                    <div class="img-thumbnail shadow w-100 bg-white position-relative text-center" style="height:190px; width:200px; margin-top:-120px">
                        <img src="{{ asset('store_assets/assets/imgs/brands/brand-3.jpg') }}" class="center-xy img-fluid" alt="Logo Brand">
                    </div>
                </div> <!--  col.// -->
                ...
                <div class="col-xl-4 text-md-end">
                    <a href="#" class="btn btn-primary"> View Store <i class="material-icons md-launch"></i> </a>
                </div> <!--  col.// -->
            </div> <!-- card-body.// -->
            <hr class="my-4">
            <div class="row g-4">
               ...
               @foreach ($store->product as $product)
                   <div class="col-xl-2 col-lg-3 col-md-6">
                    <div class="card card-product-grid">
                        ...
                        <div class="info-wrap">
                            <a href="#" class="title">{{ $product->tital }}</a>
