    ...
    <div class="row">
        <div class="col-12">
            <div class="content-header">
                <h2 class="content-title"> Edit Page DEtails </h2>
                <div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <select name="active" class="form-select">
                                <option value="1" {{ $page->active == 1 ? 'selected="selected"' : '' }} > Enabled </option>
                                <option value="0" {{ $page->active == 0 ? 'selected="selected"' : '' }} > Disabled </option>
                            </select>
                        </div>

                        <div class="mb-4">
                            <label for="product_name" class="form-label"> Arabic title </label>
                            <input type="text"  class="form-control @error('title_ar') is-invalid @enderror" name="title_ar" value="{{ $page->title_ar }}" >
                            @error('title_ar')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content_ar" id="input" class="form-control @error('content_ar') is-invalid @enderror" rows="3" required="required"> {{ $page->content_ar }} </textarea>
                            @error('content_ar')
                                <p class="text-danger"> {{ $message }} </p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text"  class="form-control @error('title_en') is-invalid @enderror" name="title_en" value="{{ $page->title_en }}" >
                            @error('title_en')
                                <p class="text-danger"> {{ $message }} </p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="product_name" class="form-label"> Arabic Content </label>
                            <textarea name="content_en" id="input" class="form-control @error('content_en') is-invalid @enderror" rows="3" required="required"> {{ $page->content_en }} </textarea>
                            @error('content_en')
                                <p class="text-danger"> {{ $message }} </p>
                            @enderror
                        </div>
